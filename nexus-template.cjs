...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "High-Acuity Crisis & Housing Dispatch";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Crisis Dispatch";
process.env.TABLE_NAME = process.env.TABLE_NAME || "crisis_dispatch_records";
'use strict';
